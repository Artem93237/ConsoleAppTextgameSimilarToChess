...
namespace ConsoleAppTextgameSimilarToChess
{
    ...
    {
        public static List<PointClass> FindNextPosition(PointClass pos)
        {
            List<PointClass> ptNxtList = new List<PointClass>();
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                if (BoardClass.InValidPostion(nr, nc)) ptNxtList.Add(new PointClass());
                else ptNxtList.Add(new PointClass(nr, nc));
            }
            return ptNxtList;
        }
